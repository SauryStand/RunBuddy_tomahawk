...
/**
 * This class is used to compare two {@link org.runbuddy.libtomahawk.resolver.Query}s.
 */
public class QueryComparator implements Comparator<Query> {
     ...
     *
     * @param flag The mode which determines with which method {@link org.runbuddy.libtomahawk.resolver.Query}s
     *             are compared
     */
