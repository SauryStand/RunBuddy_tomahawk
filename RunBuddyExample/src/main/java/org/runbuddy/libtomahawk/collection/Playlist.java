...
/**
 * A {@link Playlist} is a {@link org.runbuddy.libtomahawk.collection.Playlist} created by the user
...
public class Playlist extends Cacheable implements AlphaComparable {
    ...
    /**
     * Create a {@link Playlist} from a list of {@link org.runbuddy.libtomahawk.resolver.Query}s.
     *
     * @return a reference to the constructed {@link Playlist}
     */
    ...
    /**
     * Get the {@link org.runbuddy.libtomahawk.collection.Playlist} by providing its cache key. Only
