...
import org.runbuddy.tomahawk_android.entity.Article;
import org.runbuddy.tomahawk_android.listeners.OnItemClickListener;
...
public class TranningAdapter extends RecyclerView.Adapter<TranningAdapter.ViewHolder> {
    ...
    private List<org.runbuddy.tomahawk_android.entity.Article> mItems = new ArrayList<>();
