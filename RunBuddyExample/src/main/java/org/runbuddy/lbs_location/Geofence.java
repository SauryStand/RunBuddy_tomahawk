...
public class Geofence implements OnClickListener {
        ...
        public void onMapClick(LatLng arg0) {
            ...
            switch (fenceShape) {
                ...
                case 1:
                    ...
                    if (vertexs.size() <= 10) {
                        resourceId =
                                res.getIdentifier("icon_mark" + vertexs.size(), "drawable", trackApp.getPackageName());
                    } else {
                        resourceId = res.getIdentifier("icon_gcoding", "drawable",
    ...
    public Geofence(Context context, TomahawkApp trackApp, LayoutInflater inflater) {
